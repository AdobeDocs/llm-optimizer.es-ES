...
| Optimizar encabezados para los LLM | Optimización de contenido | Escanea los encabezados para detectar encabezados vacíos, duplicados, inexistentes o ambiguos que pueden reducir la legibilidad del equipo. | Propone una jerarquía de encabezados más limpia y mejores etiquetas, y muestra una vista previa de la estructura actualizada para cada página. | Inserta la estructura de encabezado mejorada para los agentes de IA, preservando el diseño visual al mismo tiempo que hace que la página sea más legible para los LLM. |
...
### Optimizar encabezados para los LLM

Esta oportunidad detecta páginas en las que la estructura de encabezados dificulta que los agentes de IA comprendan la página debido a encabezados vacíos, duplicados, inexistentes o ambiguos. Para cada página afectada, la oportunidad muestra los encabezados que no son óptimos y recomienda una jerarquía más clara. Cuando se implementa con Optimize at Edge, los encabezados mejorados se aplican al formato HTML servido al tráfico agéntico. Esto mejora la legibilidad automática sin alterar el diseño que ven los usuarios.
