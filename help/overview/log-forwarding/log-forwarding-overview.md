...
2. **Configurar su CDN**: use esos detalles para crear un trabajo de reenvío de registros (o cargar registros manualmente) en la consola de su proveedor de CDN.
...
| CloudFront | [Ver guía](/help/overview/log-forwarding/cloudfront.md) |
